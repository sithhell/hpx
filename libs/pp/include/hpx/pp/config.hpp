...
#        if defined(_MSC_VER) && (defined(_clang_) || \
            defined(_INTELLISENSE_) || _EDG_VERSION_ >= 308)
#            define HPX_PP_CONFIG_FLAGS() (HPX_PP_CONFIG_MSVC())
#        else
#            define HPX_PP_CONFIG_FLAGS() \
                (HPX_PP_CONFIG_EDG() | HPX_PP_CONFIG_STRICT())
#        endif
...
#        define HPX_PP_CONFIG_FLAGS() (HPX_PP_CONFIG_STRICT())
#    elif defined(_BORLANDC_) || defined(_IBMC_) || defined(_IBMCPP_) || \
          defined(_SUNPRO_CC)
...
#    if defined _GCCXML_ || defined _CUDACC_ || defined _PATHSCALE_ || \
        defined _DMC_ || defined _CODEGEARC_ || defined _BORLANDC_ || \
        defined _MWERKS_ || ( defined _SUNPRO_CC && _SUNPRO_CC < 0x5120 ) || \
        defined _HP_aCC && !defined _EDG_ || defined _MRC_ || defined _SC_ || \
...
#    /* Wave (C/C++), GCC (C++) */
#    elif defined _WAVE_ && _WAVE_HAS_VARIADICS_ || defined _GNUC_ && \
          defined _GXX_EXPERIMENTAL_CXX0X_ && _GXX_EXPERIMENTAL_CXX0X_
#        define HPX_UTIL_VARIADICS 1
...
#    if defined _MSC_VER && _MSC_VER >= 1400 && ( \
            ...
            (defined(_INTEL_COMPILER) && _INTEL_COMPILER >= 1700) || !( \
                defined _EDG_ || defined _GCCXML_ || defined _CUDACC_ || \
                defined _PATHSCALE_ || defined _DMC_ || defined _CODEGEARC_ || \
                defined _BORLANDC_ || defined _MWERKS_ || defined _SUNPRO_CC || \
                defined _HP_aCC || defined _MRC_ || defined _SC_ || \
                defined _IBMCPP_ || defined _PGI \
            ) \
        )
#        undef HPX_UTIL_VARIADICS_MSVC
